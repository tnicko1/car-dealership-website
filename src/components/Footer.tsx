                ...
                <div className="text-center md:text-left grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/cars" className="hover:text-white transition-colors">Vehicles</Link></li>
